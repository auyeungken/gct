 ...
 * 
 * Softcap : 5000 ETH equivalent to GCT 500,000,000 * 10 ** 8(decimal place)
 *
 * Usage
...
contract GCTCrowdsale {
    ...
    */
    ...
    // equivalent to 5000 ETH worth of token
    uint constant public SOFTCAP = 50000000000000000;
    uint constant public COMPANY_RESERVE = 800000000000000000;
    uint constant public PRIVATE_SALE = 90000000000000000;
    uint constant public PROMOTION_PROGRAM = 100000000000000000;
    uint constant public WEI_PER_TOKEN = 10000000000000; // 1 ETH = 10,0000 GCT
    uint constant public MIN_WEI_TO_PURCHASE = 1000000000000000;
    ...
    uint public totalMintedToken;

    uint8 constant public START_TEAM_MONTH = 4;
    ...
    address constant public admin = 0xEe00CEDc786Aa344182b02a5FB66D3D357F7e864;
    address constant public companyAccount = 0x61412EdDEf6373c9E14Ba66d3F764F00F6eB2a28;
    address constant public privateSaleAccount = 0x9Af32A8087a1cc8afB5D2B0D7Dab358Cbd677564;
    address constant public teamAccount = 0x55c6885ec95D3753DBf069812C40142a13Ec2Ce7;
    address constant public promotionAccount = 0x7b5cC7895a03B99AF0c4D1D2f023209157109df7;
    ...
    */
    function GCTCrowdsale(address _token, address _wallet) public {
    ...
    */
    ...
    function initCrowdsale() public{
        require (!isInit);
        token.setPrivatesaleAccount(privateSaleAccount);
        token.mint(privateSaleAccount, PRIVATE_SALE);
        token.mint(promotionAccount, PROMOTION_PROGRAM);
        isInit = true;
    }

    function getInfo() public view returns (address,address,address){
        return (token, token.crowdsaleAccount(), token.privateSaleAccount()) ;
    }
  ...
  // -----------------------------------------
    ...
    */
    function buyTokens(address _beneficiary) public payable {
        ...
        totalMintedToken = totalMintedToken.add(tokens);
    ...
    * @return Amount of wei left for not enough to purchase 1 GCT
    */
    function _getTokenAmount(uint256 _weiAmount) internal view returns (uint256,uint256) {
        return (_weiAmount.mul(1), 0);
    }
